class Model extends HTMLElement{
    constructor(){
        ...
        const okeynbtn = this.shadowRoot.querySelector('#okey-btn');
        ...
        okeynbtn.addEventListener('click', this._confirm.bind(this));
    }
...
customElements.define('mri-model', Model)